...
// function OrderPage() {
//   // Remove triggerOnce to animate every time elements enter view
//   const [productBoxRef, productBoxInView] = useInView({ threshold: 0.1 });
//   const [productHeaderRef, productHeaderInView] = useInView({ threshold: 0.1 });
...
//       <Navbar />
//       <div className={styles.orderPage}>
//         {/* Product Box - will animate every time it enters view */}
//         <motion.div
//           ref={productBoxRef}
//           initial="hidden"
...
//         {/* Product Header - will animate every time it enters view */}
//         <motion.div
...
//       {/* FAQ Section - will animate every time it enters view */}
//       <motion.div
//         ref={faqRef}
//         initial="hidden"
